...
import { toursArticles } from "../data"
    ...
    return (
        <section className="section" id="tours">
            ...
            <div className="section-center featured-center">
                ...
                {toursArticles.map((article) => {
                    return (
                        <article className="tour-card" key={article.id}>
                            <div className="tour-img-container">
                                <img src= {article.imgSource} className="tour-img" alt="" />
                                <p className="tour-date">{article.tourDate}</p>
                            </div>
                            <div className="tour-info">
                                <div className="tour-title">
                                    <h4>{article.tourTitle}</h4>
                                </div>
                                <p>
                                    {article.text}
                                </p>
                                <div className="tour-footer">
                                    <p>
                                        <span><i className="fas fa-map"></i></span> {article.tourCityName}
                                    </p>
                                    <p>{article.tourDuration}</p>
                                    <p>{article.tourPrice}</p>
                                </div>
                            </div>
                        </article>
